...
const adder = (arr, init) => arr.reduce((a, b) => a + b, init)
...
const sumOrMul = (arr, init) => arr.reduce((a, b) => (b % 2 === 0 ? a * b : a + b), init)

// funcExec: accepts an array of functions and executes them using reduce, returning the result.
const funcExec = (arr, init) => arr.reduce((a, b) => b(a), 0, init)
